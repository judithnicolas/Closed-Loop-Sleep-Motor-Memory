...
load([initPath.Exp '\data\group\eeg_stats\tfStat_UpVsDown_withFP.mat']) % from EEG_21_troughLockedAnalysis_withFalsePositive.m
load([initPath.Exp '\data\group\eeg_stats\tfStat_UpVsRest_withFP.mat']) % from EEG_21_troughLockedAnalysis_withFalsePositive.m
load([initPath.Exp '\data\group\eeg_stats\tfStat_DownVsRest_withFP.mat']) % from EEG_21_troughLockedAnalysis_withFalsePositive.m
load([initPath.Exp '\data\group\eeg_stats\erpStat_UpVsDown_withFP.mat']) % from EEG_21_troughLockedAnalysis_withFalsePositive.m
load([initPath.Exp '\data\group\eeg_stats\erpStat_UpVsRest_withFP.mat']) % from EEG_21_troughLockedAnalysis_withFalsePositive.m
load([initPath.Exp 'data\group\eeg_stats\erpStat_DownVsRest_withFP.mat']) % from EEG_21_troughLockedAnalysis_withFalsePositive.m
